...
import net.jyro.windows.world.models.entity.loader.internal.Vertex;
...
public class EntityLoaderOBJ {
    private static final String RES_LOC = "res/";


    public static ModelData loadOBJ(String path) {
        FileReader isr = null;
        Path pathf = Path.of(path);
        File objFile = pathf.toFile();
        try {
        ...
        ModelData data = new ModelData(verticesArray, texturesArray, normalsArray,
            new float[]{},indicesArray,furthest,0,0);
        return data;
    }
