...
public abstract class ShaderFactory {
    ...
    public ShaderFactory(String vertexFile, String fragmentFile) {
    ...
    protected void loadMatrix(int uniLocation, Matrix4f value) {
        matrixBuffer.clear();
    ...
    protected abstract  void bindAtrribs();
    ...
    private static int loadShader(String file, int type) {
        ...
        try {
            ...
            System.err.println("Could Not identify file, Check if the file is deprecated");
            e.printStackTrace();
            System.exit(-1);
        }
        ...
        if(GL20.glGetShaderi(shaderID,GL20.GL_COMPILE_STATUS) == GL11.GL_FALSE) {
            ...
            System.err.print("Shader could not be compiled");
            System.exit(-1);
        }
        return shaderID;
    }
